...
// èŽ·å–ä¸€ä¸ª elem.childNodes çš„ JSON æ•°æ®
function getChildrenJSON($elem) {
    var result = [];
    var $children = $elem.childNodes() || []; // æ³¨æ„ childNodes() å¯ä»¥èŽ·å–æ–‡æœ¬èŠ‚ç‚¹
...
Text.prototype = {
    ...
    html: function html(val) {
        ...
        if (val == null) {
            ...
            // åˆå§‹åŒ–é€‰å–ï¼Œå°†å…‰æ ‡å®šä½åˆ°å†…å®¹å°¾éƒ¨
    ...
    _saveRangeRealTime: function _saveRangeRealTime() {
        ...
        $textElem.on('mouseup', function (e) {
            saveRange();
            // åœ¨ç¼–è¾‘å™¨åŒºåŸŸä¹‹å†…å®Œæˆç‚¹å‡»ï¼Œå–æ¶ˆé¼ æ ‡æ»‘åŠ¨åˆ°ç¼–è¾‘åŒºå¤–é¢çš„äº‹ä»¶
            $textElem.off('mouseleave', saveRange);
        });
    },

    // æŒ‰å›žè½¦é”®æ—¶çš„ç‰¹æ®Šå¤„ç†
    _enterKeyHandle: function _enterKeyHandle() {
        ...
        // å°†å›žè½¦ä¹‹åŽç”Ÿæˆçš„éž <p> çš„é¡¶çº§æ ‡ç­¾ï¼Œæ”¹ä¸º <p>
        function pHandle(e) {
            var $selectionElem = editor.selection.getSelectionContainerElem();
            var $parentElem = $selectionElem.parent();

            if ($parentElem.html() === '<code><br></code>') {
                // å›žè½¦ä¹‹å‰å…‰æ ‡æ‰€åœ¨ä¸€ä¸ª <p><code>.....</code></p> ï¼Œå¿½ç„¶å›žè½¦ç”Ÿæˆä¸€ä¸ªç©ºçš„ <p><code><br></code></p>
                // è€Œä¸”ç»§ç»­å›žè½¦è·³ä¸å‡ºåŽ»ï¼Œå› æ­¤åªèƒ½ç‰¹æ®Šå¤„ç†
        ...
        // <pre><code></code></pre> å›žè½¦æ—¶ ç‰¹æ®Šå¤„ç†
        function codeHandle(e) {
            ...
            if (!editor.cmd.queryCommandSupported('insertHTML')) {
                // å¿…é¡»åŽŸç”Ÿæ”¯æŒ insertHTML å‘½ä»¤
                return;
            }

            // å¤„ç†ï¼šå…‰æ ‡å®šä½åˆ°ä»£ç æœ«å°¾ï¼Œè”ç³»ç‚¹å‡»ä¸¤æ¬¡å›žè½¦ï¼Œå³è·³å‡ºä»£ç å—
            ...
            // å¤„ç†ï¼šå›žè½¦æ—¶ï¼Œä¸èƒ½æ’å…¥ <br> è€Œæ˜¯æ’å…¥ \n ï¼Œå› ä¸ºæ˜¯åœ¨ pre æ ‡ç­¾é‡Œé¢
            ...
            if (editor.selection.getRange().startOffset + 1 === codeLength) {
                // è¯´æ˜Žå…‰æ ‡åœ¨ä»£ç æœ€åŽçš„ä½ç½®ï¼Œæ‰§è¡Œäº†å›žè½¦æ“ä½œ
                // è®°å½•ä¸‹æ¥ï¼Œä»¥ä¾¿ä¸‹æ¬¡å›žè½¦æ—¶å€™è·³å‡º code
    ...
    _clearHandle: function _clearHandle() {
        ...
        $textElem.on('keydown', function (e) {
            ...
            if (txtHtml === '<p><br></p>') {
                // æœ€åŽå‰©ä¸‹ä¸€ä¸ªç©ºè¡Œï¼Œå°±ä¸å†åˆ é™¤äº†
                e.preventDefault();
                return;
            }
        });
    ...
    _pasteHandle: function _pasteHandle() {
        ...
        // ç²˜è´´å›¾ç‰‡ã€æ–‡æœ¬çš„äº‹ä»¶ï¼Œæ¯æ¬¡åªèƒ½æ‰§è¡Œä¸€ä¸ª
        ...
        function canDo() {
            ...
            if (now - pasteTime >= 500) {
                // é—´éš”å¤§äºŽ 500 ms ï¼Œå¯ä»¥æ‰§è¡Œ
                flag = true;
            }
            pasteTime = now;
            return flag;
        ...
        $textElem.on('paste', function (e) {
            ...
            // ç²˜è´´å›¾ç‰‡å’Œæ–‡æœ¬ï¼Œåªèƒ½åŒæ—¶ä½¿ç”¨ä¸€ä¸ª
            if (!canDo()) {
                return;
            }
